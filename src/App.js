        ...
        <>
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex justify-between items-start mb-2">
                  <p className="text-sm font-medium text-indigo-700">노출 수</p>
                  <div className="p-1.5 bg-indigo-100 rounded-full">
                    <Eye className="w-4 h-4 text-indigo-600" />
                  </div>
                </div>
                <p className="text-2xl font-bold mt-1 text-gray-800">12,458</p>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-5 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex justify-between items-start mb-2">
                  <p className="text-sm font-medium text-emerald-700">클릭 수</p>
                  <div className="p-1.5 bg-emerald-100 rounded-full">
                    <MousePointer className="w-4 h-4 text-emerald-600" />
                  </div>
                </div>
                <p className="text-2xl font-bold mt-1 text-gray-800">1,285</p>
                <div className="flex items-center mt-2 text-green-600 text-sm">
                  <TrendingUp className="w-4 h-4 mr-1" />
              ...
              <div className="bg-gradient-to-br from-amber-50 to-yellow-50 p-5 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex justify-between items-start mb-2">
                  <p className="text-sm font-medium text-amber-700">CTR</p>
                  <div className="p-1.5 bg-amber-100 rounded-full">
                    <LineChart className="w-4 h-4 text-amber-600" />
                  </div>
                </div>
                <p className="text-2xl font-bold mt-1 text-gray-800">10.3%</p>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 p-5 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex justify-between items-start mb-2">
                  <p className="text-sm font-medium text-violet-700">방문 수</p>
                  <div className="p-1.5 bg-violet-100 rounded-full">
                    <MapPin className="w-4 h-4 text-violet-600" />
                  </div>
                </div>
                <p className="text-2xl font-bold mt-1 text-gray-800">421</p>
                <div className="flex items-center mt-2 text-green-600 text-sm">
                  <TrendingUp className="w-4 h-4 mr-1" />
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center mb-4">
              ...
              <select className="border border-gray-200 rounded-lg px-3 py-1.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                <option>최근 7일</option>
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex space-x-2">
                  <button className="px-2 py-1 text-xs bg-blue-50 text-blue-700 rounded-md hover:bg-blue-100">일별</button>
                  <button className="px-2 py-1 text-xs bg-gray-50 text-gray-700 rounded-md hover:bg-gray-100">주별</button>
                  <button className="px-2 py-1 text-xs bg-gray-50 text-gray-700 rounded-md hover:bg-gray-100">월별</button>
                </div>
              </div>
              ...
              <div className="h-64 relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 top-0 flex flex-col justify-between">
                  {[0, 1, 2, 3, 4].map((index) => (
                    <div key={index} className="border-b border-gray-100 w-full h-0 relative">
                      <span className="absolute -top-2.5 -left-8 text-xs text-gray-400">
                        {(5 - index) * 25}00
                      </span>
                    </div>
                  ))}
                ...
                {/* 샘플 데이터 차트 */}
                <div className="absolute bottom-0 left-10 right-2 h-full flex items-end">
                  {['월', '화', '수', '목', '금', '토', '일'].map((day, idx) => {
                    const heights = ['35%', '45%', '60%', '40%', '55%', '75%', '50%'];
                    const clickHeights = ['15%', '25%', '35%', '20%', '30%', '45%', '25%'];
                    const visitHeights = ['8%', '12%', '18%', '10%', '15%', '22%', '14%'];
                    return (
                      <div key={idx} className="flex-1 flex flex-col items-center justify-end mx-1 relative">
                        <div className="absolute bottom-0 w-1/2 bg-purple-500 rounded-t" style={{ height: visitHeights[idx] }}></div>
                        <div className="absolute bottom-0 w-3/4 bg-emerald-500 rounded-t opacity-70" style={{ height: clickHeights[idx] }}></div>
                        <div className="absolute bottom-0 w-full bg-blue-400 rounded-t opacity-60" style={{ height: heights[idx] }}></div>
                        <span className="absolute -bottom-6 text-xs text-gray-600">{day}</span>
                      </div>
                    );
                  })}
                </div>
              ...
              <div className="mt-8 pt-2 border-t border-gray-100 flex justify-between">
                <div className="text-sm text-gray-500">
                  <span className="font-medium text-gray-700">주간 요약:</span> 토요일에 가장 높은 참여도 (노출: 1,870, 클릭: 225)
                </div>
                <button className="text-sm text-blue-600 hover:text-blue-800">상세 분석 →</button>
              </div>
            </div>
          </div>
        </>
        ...
        <div className="space-y-8">
          <div>
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                <div className="flex space-x-2">
                  <button className="px-3 py-1.5 text-xs bg-blue-600 text-white rounded-lg shadow-sm">시간대</button>
                  <button className="px-3 py-1.5 text-xs bg-gray-100 text-gray-700 rounded-lg">요일</button>
                </div>
                <div className="text-sm text-gray-500">
                  <span className="font-medium text-gray-700">피크 타임:</span> 18:00 - 21:00
                </div>
              </div>
              ...
              <div className="h-72 flex items-end justify-between px-2 relative">
                <div className="absolute -left-2 top-0 bottom-8 flex flex-col justify-between">
                  {[0, 20, 40, 60, 80, 100].reverse().map((percent, idx) => (
                    <div key={idx} className="text-xs text-gray-400 w-8 text-right">
                      {percent}%
                    </div>
                  ))}
                </div>
                ...
                {/* 시간대별 바차트 */}
                <div className="absolute left-8 right-0 bottom-0 top-0 flex items-end pt-2">
                  {['06-09', '09-12', '12-15', '15-18', '18-21', '21-24'].map((time, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex-1 px-1 flex flex-col items-center justify-end h-full">
                        <div className={`w-full ${hoverEffect} rounded-t-lg bg-gradient-to-b ${colors[idx]}`} 
                          style={{ height: heights[idx], transition: 'all 0.5s ease' }}>
                          <div className="flex justify-center items-start pt-2 text-white font-medium">
                            {heights[idx].replace('%', '')}%
                          </div>
                        </div>
                        <div className="h-8 flex items-center justify-center w-full">
                          <span className="text-xs text-gray-600 mt-2">{time}</span>
                        </div>
                      </div>
                    );
                  })}
              ...
              <div className="mt-2 bg-blue-50 p-4 rounded-lg border border-blue-100">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-blue-800 font-medium">인사이트</p>
                    <p className="text-sm text-blue-700 mt-1">
                      18시~21시 사이에 가장 높은 참여율(78%)을 보이며, 점심 시간대(12시~15시)도 높은 참여율(65%)을 나타냅니다. 
                      이 시간대에 타겟팅을 강화하여 광고 효율을 높일 수 있습니다.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="text-sm text-gray-500">
                  <span className="font-medium text-gray-700">최고 참여:</span> 토요일 (90%)
                </div>
              </div>
                ...
                <div className="absolute left-8 right-0 bottom-0 top-0 flex items-end pt-2">
                  {['월', '화', '수', '목', '금', '토', '일'].map((day, idx) => {
                    ...
                    const getColor = (height) => {
                      ...
                      if (value >= 70) return 'from-green-300 to-green-600';
                      if (value >= 50) return 'from-yellow-300 to-yellow-600';
                    ...
                    return (
                      <div key={idx} className="flex-1 px-1 flex flex-col items-center justify-end h-full">
                        <div className={`w-full ${hoverEffect} rounded-t-lg bg-gradient-to-b ${getColor(heights[idx])}`} 
                          style={{ height: heights[idx], transition: 'all 0.5s ease' }}>
                          <div className="flex justify-center items-start pt-2 text-white font-medium">
                            {heights[idx].replace('%', '')}%
                          </div>
              ...
              <div className="mt-2 bg-blue-50 p-4 rounded-lg border border-blue-100">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-blue-800 font-medium">인사이트</p>
                    <p className="text-sm text-blue-700 mt-1">
                      주말(토요일)에 가장 높은 참여율(90%)을 보이며, 금요일(75%)에도 높은 참여가 있습니다. 
                      주말 광고 예산을 증액하고 특별 프로모션을 진행하는 것이 효과적일 수 있습니다.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                  ...
                  <div className="flex items-center justify-center space-x-4 py-4">
                    <div className="relative">
                      <div className="flex flex-col items-center">
                        <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-4 rounded-xl shadow-sm w-40">
                          <div className="flex justify-center mb-2">
                            <div className="p-2 bg-gray-600 rounded-full">
                              <Eye className="w-6 h-6 text-white" />
                            </div>
                          </div>
                          <p className="text-sm font-medium text-center text-gray-700">노출</p>
                          <p className="text-2xl font-bold text-center mt-1">12,458</p>
                          <p className="text-xs text-gray-500 text-center mt-1">100%</p>
                        </div>
                        <div className="h-2 w-2 bg-gray-300 rounded-full mt-1 mb-1"></div>
                        <div className="h-2 w-2 bg-gray-300 rounded-full mb-1"></div>
                        <div className="h-2 w-2 bg-gray-300 rounded-full"></div>
                      </div>
                      
                      <div className="absolute h-1 bg-gradient-to-r from-gray-300 to-blue-400 top-16 -right-4 w-8 transform rotate-90 origin-right"></div>
                    </div>
                    
                    <div className="relative">
                      <div className="flex flex-col items-center">
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-xl shadow-sm border border-blue-200 w-40">
                          <div className="flex justify-center mb-2">
                            <div className="p-2 bg-blue-600 rounded-full">
                              <MousePointer className="w-6 h-6 text-white" />
                            </div>
                          </div>
                          <p className="text-sm font-medium text-center text-blue-700">클릭</p>
                          <p className="text-2xl font-bold text-center mt-1">1,285</p>
                          <div className="flex items-center justify-center mt-1">
                            <p className="text-xs bg-blue-200 text-blue-800 px-2 py-0.5 rounded-full">전환율: 10.3%</p>
                          </div>
                        </div>
                        <div className="h-2 w-2 bg-blue-300 rounded-full mt-1 mb-1"></div>
                        <div className="h-2 w-2 bg-blue-300 rounded-full mb-1"></div>
                        <div className="h-2 w-2 bg-blue-300 rounded-full"></div>
                      </div>
                      
                      <div className="absolute h-1 bg-gradient-to-r from-blue-300 to-green-400 top-16 -right-4 w-8 transform rotate-90 origin-right"></div>
                    </div>
                    
                    <div className="relative">
                      <div className="flex flex-col items-center">
                        <div className="bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-xl shadow-sm border border-green-200 w-40">
                          <div className="flex justify-center mb-2">
                            <div className="p-2 bg-green-600 rounded-full">
                              <MapPin className="w-6 h-6 text-white" />
                            </div>
                          </div>
                          <p className="text-sm font-medium text-center text-green-700">방문</p>
                          <p className="text-2xl font-bold text-center mt-1">421</p>
                          <div className="flex items-center justify-center mt-1">
                            <p className="text-xs bg-green-200 text-green-800 px-2 py-0.5 rounded-full">전환율: 32.8%</p>
                          </div>
                        </div>
                        <div className="h-2 w-2 bg-green-300 rounded-full mt-1 mb-1"></div>
                        <div className="h-2 w-2 bg-green-300 rounded-full mb-1"></div>
                        <div className="h-2 w-2 bg-green-300 rounded-full"></div>
                      </div>
                      
                      <div className="absolute h-1 bg-gradient-to-r from-green-300 to-orange-400 top-16 -right-4 w-8 transform rotate-90 origin-right"></div>
                    </div>
                    
                    <div className="relative">
                      <div className="flex flex-col items-center">
                        <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-4 rounded-xl shadow-sm border border-orange-200 w-40">
                          <div className="flex justify-center mb-2">
                            <div className="p-2 bg-orange-600 rounded-full">
                              <ShoppingCart className="w-6 h-6 text-white" />
                            </div>
                          </div>
                          <p className="text-sm font-medium text-center text-orange-700">구매</p>
                          <p className="text-2xl font-bold text-center mt-1">198</p>
                          <div className="flex items-center justify-center mt-1">
                            <p className="text-xs bg-orange-200 text-orange-800 px-2 py-0.5 rounded-full">전환율: 47.0%</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="mt-6 bg-blue-50 p-4 rounded-lg border border-blue-100">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-blue-800 font-medium">행동 흐름 인사이트</p>
                    <p className="text-sm text-blue-700 mt-1">
                      노출에서 클릭까지의 전환율은 10.3%로 업계 평균(8.5%)보다 높으며, 방문자의 47%가 구매로 이어져 높은 전환율을 보입니다.
                      특히 방문-구매 전환율이 높은 점은 매장 내 경험이 우수함을 시사합니다.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 grid grid-cols-3 gap-3">
                  <div className="bg-white p-2 rounded-lg border border-blue-200">
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-gray-600">전체 전환율</span>
                      <span className="text-xs font-medium text-green-700">1.6%</span>
                    </div>
                    <p className="text-sm font-semibold mt-1">노출 → 구매</p>
                  </div>
                  <div className="bg-white p-2 rounded-lg border border-blue-200">
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-gray-600">이탈률</span>
                      <span className="text-xs font-medium text-red-700">53.0%</span>
                    </div>
                    <p className="text-sm font-semibold mt-1">방문 → 이탈</p>
                  </div>
                  <div className="bg-white p-2 rounded-lg border border-blue-200">
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-gray-600">재방문율</span>
                      <span className="text-xs font-medium text-green-700">28.5%</span>
                    </div>
                    <p className="text-sm font-semibold mt-1">7일 이내</p>
                  </div>
                </div>
              </div>
            </div>
